import PrimeReact, { FilterMatchMode } from 'primereact/api/api.esm.js';
import { ComponentBase } from 'primereact/componentbase/componentbase.esm.js';
import { ObjectUtils, classNames } from 'primereact/utils/utils.esm.js';
...
const classes = {
	root: ({ props, selectable }) => classNames('p-datatable p-component', {
	...
	table: ({ props }) => classNames('p-datatable-table', {
	...
	bodyCell: ({
		selectionMode, editor, editingState, frozen, cellSelected, align, bodyProps: props, getCellParams
	}) => classNames({
	...
	bodyRow: ({ rowProps: props }) => classNames({
	...
	headerFilterClearButton: ({ hasRowFilter }) => classNames('p-column-filter-clear-button p-link', {
	...
	filterOverlay: ({ columnFilterProps: props, context, getColumnProp }) => classNames('p-column-filter-overlay p-component p-fluid', getColumnProp('filterMenuClassName'), {
		'p-column-filter-overlay-menu': props.display === 'menu',
		'p-input-filled': (context && context.inputStyle === 'filled') || PrimeReact.inputStyle === 'filled',
		'p-ripple-disabled': (context && context.ripple === false) || PrimeReact.ripple === false
	}),
	columnFilter: ({ columnFilterProps: props }) => classNames('p-column-filter p-fluid', {
	...
	headerCheckbox: ({ headerProps: props, focusedState }) => classNames('p-checkbox-box p-component', {
	...
	headerCell: ({
		headerProps: props, frozen, sortMeta, align, _isSortableDisabled, getColumnProp
	...
	footerCell: ({ getColumnProp, align }) => classNames({
